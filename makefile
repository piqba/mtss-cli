...
# Add linker flags
linker_flags = '-s -X github.com/piqba/mtss-cli/cmd/cli/commands.buildTime=${current_time} -X github.com/piqba/mtss-cli/cmd/cli/commands.versionHash=${git_hash} -X github.com/piqba/mtss-cli/cmd/cli/commands.version=${version}'
...
compile:
	...
	GOOS=linux GOARCH=amd64 go build  -o ./build/${nameAPI}-${version}-linux-amd64 cmd/api/main.go
